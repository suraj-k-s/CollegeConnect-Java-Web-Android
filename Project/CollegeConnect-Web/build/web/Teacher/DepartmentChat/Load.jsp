...
<%
    String selQry = "select * from tbl_department_chat dc inner join tbl_department d on (dc.to_department_id=d.department_id) or (dc.from_department_id=d.department_id) where d.department_id='" + session.getAttribute("tdid") + "' order by dc_date";

...
<h1 align="center" id="heading">Department Data</h1>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                                                int i = 0;
                    String selQry = "select * from tbl_department d inner join tbl_college c on c.college_id=d.department_id inner join tbl_department_type dt on dt.department_type_id=d.department_type_id";

                        ...
                        <div id="signup-panel-2" class="process-panel-wrap is-narrow">
                            <div class="form-panel">
                                ...
                                <div class="field">
                                    <label>Contact</label>
                                    <div class="control">
                                        <input  required="" type="tel" pattern="^\d{10}$" id="txt_number" name="txt_number" class="input" placeholder="Enter College contact">
                                    </div>
                                </div>
                        ...
                        <div id="signup-panel-4" class="process-panel-wrap is-narrow">
                            <div class="form-panel">
                                ...
                                <div class="field">
                                    ...
                                    <div class="control">
                                        <input required="" type="password" placeholder="Choose a password" class="input" id="txt_password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
                                               title="Must contain at least one  number and one uppercase and lowercase letter, and at least 8 or more characters" name="txt_password">

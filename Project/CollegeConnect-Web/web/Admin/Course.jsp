    ...
    <%        String id = "", name = "", dis = "";
        ...
        if (request.getParameter("btn_save") != null) {
            ...
            if (request.getParameter("hid").equals("")) {
                String insQry = "insert into tbl_course(department_type_id,course_name)values('" + request.getParameter("sel_department_type") + "','" + request.getParameter("txt_course") + "')";
                con.executeCommand(insQry);
                response.sendRedirect("Course.jsp");
            } else {
                String upQry = "update tbl_course set department_type_id='" + request.getParameter("sel_department_type") + "',course_name='" + request.getParameter("txt_course") + "' where course_id='" + request.getParameter("hid") + "'";
                            ...
                            <div class="QA_section">
                                        ...
                                        <div class="white_box mb_30">
                                            ...
                                            <form>
                                                <div class="form-group">
                                                    ...
                                                    <select required="" class="form-control" name="sel_department_type" id="sel_department_type">
                                                        ...
                                                        <%                                                            String disQry = "select * from tbl_department_type";
                                                            ...
                                                            while (rs1.next()) {
                                                        %>
                                                        <option value="<%=rs1.getString("department_type_id")%>" <%if (dis.equals(rs1.getString("department_type_id"))) {
                                                                out.println("selected");
                                                            }%>><%=rs1.getString("department_type_name")%></option>
                                                        <%
                                                            }
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input required="" type="text" class="form-control" value="<%=name%>" id="txt_course" name="txt_course">
                                ...
                                <div class="QA_table mb_30">
                                    ...
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody>
                                            <%                                                int i = 0;
                                                String selQry = "select * from tbl_course p inner join tbl_department_type d on d.department_type_id=p.department_type_id";
                                            ...
                                            <tr>    
                                                ...
                                                <td align="center"> 
                                                    ...
                                                    <a class="status_btn" href="Course.jsp?edit=<%=rs.getString("course_id")%>&name=<%=rs.getString("course_name")%>&id=<%=rs.getString("department_type_id")%>">Edit</a>
                                                </td> 
                                            </tr>
                                            <%                      }

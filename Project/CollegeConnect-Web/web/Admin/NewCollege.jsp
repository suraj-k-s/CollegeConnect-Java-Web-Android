    ...
    <%        common_classes.mailconnection m = new common_classes.mailconnection();
        ...
        if (request.getParameter("aid") != null) {
            ...
            String text = "Respected " + name + " Administrator, \r\n \r\n"
                    + " This is from college connect team,thank you for signing up to our service. \r\n"
                    + " We established College connect in order to bring the College community more closer and effective. \r\n"
